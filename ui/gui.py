...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.company_name_box = QtWidgets.QLineEdit(self.centralwidget)
        self.company_name_box.setGeometry(QtCore.QRect(260, 180, 201, 21))
        self.company_name_box.setObjectName("company_name_box")
        self.company_name_label = QtWidgets.QLabel(self.centralwidget)
        self.company_name_label.setGeometry(QtCore.QRect(110, 180, 111, 21))
        self.company_name_label.setObjectName("company_name_label")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(90, 420, 113, 32))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.disclaimer_label.setText(_translate("MainWindow", "Make your life less of a nightmare"))
